# Support for Output Descriptors in BitcoinEvolution Core

Since BitcoinEvolution Core v0.17, there is support for Output Descriptors in the
...
on BitcoinEvolution's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing BitcoinEvolution Core wallets, a convenience function `combo` is
