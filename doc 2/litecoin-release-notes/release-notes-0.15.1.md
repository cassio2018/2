BitcoinEvolution Core version *0.15.1* is now available from:

  <https://download.bitcoinevolution.org/bitcoinevolution-0.15.1/>
...
A number of changes to the way BitcoinEvolution Core deals with peer connections and invalid blocks
